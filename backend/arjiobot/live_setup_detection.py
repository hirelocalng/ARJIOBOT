...
def _apply_one_attempt_trace(
    ...
    *,
    ...
    for key in (
        ...
        "current_price_zone_position",
        "retrace_window_candles",
        "retrace_window_required_candles",
        "retrace_window_complete",
        "retrace_window_start",
        "retrace_window_end",
        "entry_zone_touched",
        "entry_zone_first_touch_timestamp",
